    ...
    <div className="App">
      <div className="container">
        <div className="details">
          <h1 id="topic" style={{ marginBottom: "1.5rem", color: "#55AD9B" }}>
            About Me
          </h1>
            ...
            <div className="container-2">
              ...
              <div className="text">
                <p>
                  ...
                  strong passion in software development and programming eager
                  to apply their expertise in practical projects.
                </p>
              </div>
            </div>
            <div className="container-2">
              ...
              <div className="text">
                <p>
                  Gained fluency in HTML, CSS, JS, Python, Java, SQL, React
                  Native and React JS through projects.
                </p>
              </div>
            </div>
            <div className="container-2">
              ...
              <div className="text">
                <p>
                  Enjoys working in groups, seeking challenges and is dedicated
                  to becoming the best software engineer.
                </p>
              </div>
            </div>
          </div>
